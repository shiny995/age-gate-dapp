...
export class Contract {
      ...
      checkEligibility: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('checkEligibility',
                                     ...
                                     'age_gate.compact line 7 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _age_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
      __compactRuntime.typeError('age',
                                 'return value',
                                 'age_gate.compact line 5 char 1',
                                 'Uint<0..256>',
                                 result_0)
    }
  ...
  _checkEligibility_0(context, partialProofData) {
    const MIN_AGE_0 = 18n;
    const t_0 = this._age_0(context, partialProofData); return t_0 >= MIN_AGE_0;
  }
}
...
const _dummyContract = new Contract({ age: (...args) => undefined });
